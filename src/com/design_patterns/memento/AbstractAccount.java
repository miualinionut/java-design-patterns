...
import com.design_patterns.mediator.NotEnoughFundsException;
...
public abstract class AbstractAccount implements Cloneable {
	...
	public void withdraw(final double amount) throws com.design_patterns.mediator.NotEnoughFundsException {
		if (amount < 0) {
